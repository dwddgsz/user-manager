		...
		return (
			<FilterWrapper onSubmit={this.props.handleOnSubmit}>
				<div className='search__field-group'>
					<label className='search__label' htmlFor='searchPhrase'>
						Last Name
					</label>
					<input
						id='searchPhrase'
						...
						type='text'
						className='search__by-name'
					></input>
				</div>

				<div className='search__by-age-container'>
					<div className='search__field-group'>
						<label className='search__label' htmlFor='minAge'>
							min age
						</label>
						<input
							id='minAge'
							...
							type='number'
							className='search__by-age'
						></input>
					</div>

					<div className='search__field-group'>
						<label className='search__label' htmlFor='maxAge'>
							max Age
						</label>
						<input
							id='maxAge'
